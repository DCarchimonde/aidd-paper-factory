...
FINAL_RUNNER = SCRIPT_DIR / "30_build_paper1_submission_final_v3.py"
...
ENTRY_SCRIPTS = [
    ...
    SCRIPT_DIR / "29_build_submission_artwork_strict_v3.py",
    SCRIPT_DIR / "30_build_paper1_submission_final_v3.py",
]
...
def main() -> None:
    ...
    for script in IMPORTED_LIBS:
        py_compile.compile(str(script), doraise=True)
        print("  OK library", script.name)
    print("SUBMISSION-FINAL PYTHON PREFLIGHT: PASS")
    print("No model fitting, partition generation, or inferential recomputation is invoked by this entrypoint.")
