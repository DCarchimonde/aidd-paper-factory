...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Audit size-locked scaffold pairs before model retraining."
    )
...
def main() -> None:
    ...
    suffix = f"locked_{args.acyclic_mode}"
    paths = {
    ...
    if not bool(pairs["exact_size_match"].all()):
        ...
        print("\nWARNING: Some paired scaffold partitions are not exact size matches:")
