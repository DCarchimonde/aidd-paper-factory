...
RUNNER = ROOT / "paper1_leakage_benchmark" / "scripts" / "40_run_paper1_sarqsar_overnight_v1.py"
...
def set_awake(enabled: bool) -> None:
    ...
    if result == 0:
        print("NOTICE: Windows sleep-prevention request was not accepted; verify the power settings manually.", flush=True)
    else:
